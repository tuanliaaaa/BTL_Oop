...
function GetSubjectByTermNow()
{
    ...
    xhttp.open("GET", "/Subject/SubjectByTermNow",false);
...
function GetTermSubjectStudentNow(){
    ...
    xhttp.open("GET", "/Subject/AllSubjectSignedByTermNow",false);
    token = localStorage.getItem("Token");
    authorization ='Bearer '+token
    xhttp.setRequestHeader("Authorization",authorization);
    xhttp.send();
...
function PostTermSubjectStudentNow(subjectCode)
{
    ...
    xhttp.open("POST", "/SignSubject/SignSubjectBySubjectCode",false);
...
function DeleteTermSubjectStudentBysubjectCode(oke){
    ...
    xhttp.open("DELETE", "/SignSubject/SignSubjectBySubjectCode/"+subjectCode,false);
    xhttp.setRequestHeader("Content-type","application/json")
    xhttp.setRequestHeader("X-CSRFToken", csrfToken);
    token = localStorage.getItem("Token");
    authorization ='Bearer '+token
